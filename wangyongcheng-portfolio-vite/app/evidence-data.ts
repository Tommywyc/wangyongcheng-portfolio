...
export const evidenceCategories: EvidenceCategory[] = [
  {
    ...
    items: [
      { id: "evidence-cet4", title: "CET-4 成绩：568分", titleEn: "CET-4 Score · 568", meta: "听力177 · 阅读220 · 写作和翻译171 · 证件信息已脱敏", metaEn: "Listening 177 · Reading 220 · Writing & Translation 171 · identifiers redacted", href: "/evidence/cet4-568-redacted.jpg", image: "/evidence/cet4-568-redacted.jpg" },
  ...
  },
  {
    ...
    items: [
      { id: "evidence-moot-court", title: "模拟法庭优胜奖", titleEn: "Moot Court Merit Award", meta: "校级竞赛 · 28支队伍第7名", metaEn: "University-level competition · 7th among 28 teams", href: "/evidence/moot-court-award-public.jpg", image: "/evidence/moot-court-award-public.jpg" },
      ...
      { id: "evidence-neccs-exam", title: "全国大学生英语竞赛考试形式", titleEn: "National English Competition · Exam Format", meta: "竞赛备考与题型参考", metaEn: "competition preparation and format reference", href: "/evidence/neccs-exam-format-public.jpg", image: "/evidence/neccs-exam-format-public.jpg" },
    ],
  },
  {
    label: "志愿服务",
    ...
    items: [
      { id: "evidence-volunteer", title: "志愿服务50小时记录", titleEn: "50 Hours of Volunteer Service", meta: "志愿四川 · 截至2026.06 · 身份信息与二维码已脱敏", metaEn: "Sichuan Volunteer Service · through 2026.06 · identifiers and QR code redacted", href: "/evidence/volunteer-50-hours-redacted.jpg", image: "/evidence/volunteer-50-hours-redacted.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "evidence-yunda-run-certificate", title: "“运达杯”体育节环校跑", titleEn: "Yunda Cup Campus Run", meta: "2025.11.23 · 3.31公里 · 学生组", metaEn: "2025.11.23 · 3.31 km · student division", href: "/evidence/yunda-run-certificate-public.jpg", image: "/evidence/yunda-run-certificate-public.jpg" },
  ...
  },
  {
    ...
    items: [
      { id: "evidence-ai-paper", title: "生成式AI与学习者能动性研究", titleEn: "Generative AI & Learner Agency Paper", meta: "大一下期末英文研究论文 · 完整原文联系后提供", metaEn: "Freshman spring research paper · full text available on request", href: "mailto:w3194510963@gmail.com?subject=Evidence%20request%20%E2%80%94%20Generative%20AI%20%26%20Learner%20Agency", document: true, restricted: true },
      { id: "evidence-literature-paper", title: "《死亡诗社》中的爱、控制与孝道", titleEn: "Love, Control & Filial Piety in Dead Poets Society", meta: "大一上期末英文研究论文 · 完整原文联系后提供", metaEn: "Freshman fall research paper · full text available on request", href: "mailto:w3194510963@gmail.com?subject=Evidence%20request%20%E2%80%94%20Dead%20Poets%20Society%20Paper", document: true, restricted: true },
      { id: "evidence-information-literacy-script", title: "信息茧房微视频提交脚本", titleEn: "Information Bubble Microvideo Submission Script", meta: "2026.07 · 信息素养大赛作品文档 · 完整材料联系后提供", metaEn: "2026.07 · information literacy competition document · full material available on request", href: "mailto:w3194510963@gmail.com?subject=Evidence%20request%20%E2%80%94%20Information%20Literacy%20Script", document: true, restricted: true, documentLabel: "Competition Script" },
    ],
  },
];
